...
@Retention(AnnotationRetention.RUNTIME) @MetaAnnotation @Flavor("umami") annotation class Umami()
...
class TestAnnotationScannerTest {
    ...
    @NotInherited("only for this class") @Flavor("tangy") open class Superclass
