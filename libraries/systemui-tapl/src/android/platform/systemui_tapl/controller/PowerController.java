...
public class PowerController {
    ...
    private static final String POWER_COMMAND = String.format("input keyevent --longpress  %s",
            KEYCODE_POWER);
    private static final String POWER_BUTTON_LONG_PRESS_BEHAVIOR =
    ...
    public int setLongPressOnPowerBehavior(int behavior) {
        ...
        try {
            oldLongPressPowerKeyBehavior = Settings.Global.getInt(
        ...
        assertThat(Settings.Global.putInt(context.getContentResolver(),
                POWER_BUTTON_LONG_PRESS_BEHAVIOR, behavior)).isTrue();
